...
#SERVER DOMAIN
DOMAIN="adipbot.000webhostapp.com"

#DEBUG
DEBUG=0
MAIL="pekenio@protonmail.com"

#DATABASE
HOST="localhost"
USER="id6711921_pekenio009"
PASS="coulibal7"
BDD="id6711921_pekenio"

#TELEGRAM
APP_ID="664911707"
APP_NAME="AdiP_investbot"

#CHAINBLOCK
WALLET_ID="54580eae-a49d-4162-b51e-6a26cb7aeef6"
WALLET_PASSWORD="coulibal7"
WALLET_PASSWORD_SECOND="coulibal7"

#RULES
MINIMUM_INVEST="0.001"
...
COMMISSION_RATE="140%"
TIMER_TIME_HOUR="24"
REQUIRED_CONFIRMATIONS="yes"
INTEREST_ON_REINVEST="140%"
WITHDRAW_FEE="0.0003"

#SUPPORT
SUPPORT_CHAT_ID="507198259"
...
#SERVER DOMAIN
while [ "$DOMAIN" == "adipbot.000webhostapp.com" ]
do
	DOMAIN_DEFAULT=""
...
while [ "$MAIL" == "pekenio@protonmail.com"]
do
        MAIL_DEFAULT=""
...
while [ "$USER" == "id6711921_pekenio009" ]
do
        USER_DEFAULT="root"
...
#CHAINBLOCK
while [ "$WALLET_ID" == "54580eae-a49d-4162-b51e-6a26cb7aeef6" ]
do
        WALLET_ID_DEFAULT="54580eae-a49d-4162-b51e-6a26cb7aeef6"
...
while [ "$WALLET_PASSWORD" == "coulibal7@" ]
do
...
while [ "$WALLET_PASSWORD_SECOND" == "coulibal7@" ]
do
...
while [ "$MINIMUM_REINVEST" == "0.002" ]
do
        MINIMUM_REINVEST_DEFAULT="0.002"
...
while [ "$REQUIRED_CONFIRMATIONS" == "6" ]
do
